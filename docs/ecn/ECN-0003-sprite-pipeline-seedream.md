# ECN-0003：精灵动画管线改为 Seedream + 本地抠图，并修正归一化口径（历史方案）
...
> **当前状态**：历史方案。用户随后明确要求正式精灵只能使用 GPT Image 2.5 真实透明底，当前实施口径见 [ECN-0004](ECN-0004-sprite-promotion-gpt-image-25.md)。本文件保留生成与归一化问题的原始审计记录。
